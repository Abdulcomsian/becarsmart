...
<body style=" margin:0px; font-family: 'Poppins', sans-serif;">
    <section id="header" style="width: 100%; max-width:80%;  margin:0 auto;">
        ...
        <p style="color: #2c3b53;font-size: 25px; font-weight: 700; text-align:center">Thank you for  <br> completing our vehicle <br> valuation form.</p>
...
<body style=" margin:0px; font-family: 'Poppins', sans-serif;">
    <section id="header" style="width: 100%; max-width:80%;  margin:0 auto;">
        ...
        <p style="color: #2c3b53;font-size: 20px; font-weight: 700; text-align:center">User has submitted <br> a query from contact us form.</p>
...
</html>     <td align="center" valign="top"><table class="contenttable" border="0" cellpadding="0" cellspacing="0" width="600" bgcolor="#ffffff" style="border-width:1px; border-style: solid; border-collapse: separate; border-color:#ededed; margin-top:20px; font-family:Arial, Helvetica, sans-serif">
                <tr>
                  <td></td>
                </tr>
                <tr>
