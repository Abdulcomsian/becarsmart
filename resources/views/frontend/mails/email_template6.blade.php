      ...
      <section id="header" style="width: 100%; max-width:50%;  margin:0 auto;">
         ...
         <div class="multipale-button" style="text-align: center; width:100%; display:inline-flex;max-width: 100%;">
            <div style="width: 80%;margin: 0 auto;">
               <center>
                  <div style="background-color: #f5d11b;border-radius: 10px;width: 100%;max-width: 100%;line-height: 0;padding: 2% 0;">
         ...
         <div class="multipale-button" style="text-align: center; width:100%; display:inline-flex;max-width: 100%;">
            <div style="width:50%;margin: 0 auto;">
               <center>
                  <div style="border: 15px solid #e74f42;width:100%;max-width: 100%;line-height: 0;">
                     <p style="text-align: left;font-size: 60px;text-transform: uppercase;font-weight: 600;line-height: 0px;padding: 0px 15px;">£ {{ $email_template6['amount']}}</p>
                  </div>
               </center>
            </div>
         </div>
         ...
         <p style="color: #2c3b53;font-size: 21px; text-transform: initial; font-weight: 500; text-align:left">This is a vehicle we have found after the original 'sourcing consultation'. <br> We believe it meets your criteria from what you have told us you're looking for. <br> Please see attached are more pictures and a condition report. 
            <br><br>Please contact us if interested on: 023******* or respond back to this email.
         </p>
         <br><br>
      </section>
   </body>
