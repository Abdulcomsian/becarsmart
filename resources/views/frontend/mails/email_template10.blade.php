...
<body style=" margin:0px; font-family: 'Poppins', sans-serif;">
    <section id="header" style="width: 100%; max-width:50%;  margin:0 auto;">
        ...
        <br>
        <h3 style="text-align:center;color: rgb(44 59 83);font-size: 40px;line-height: 40px;text-transform: uppercase;font-weight: 600;margin-bottom: -16px;">CONGRATULATIONS! <br> YOU'RE NOW SIGNED UP.</h3>
