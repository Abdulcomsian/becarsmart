...
<body style=" margin:0px; font-family: 'Poppins', sans-serif;">
    <section id="header" style="width: 100%; max-width:50%;  margin:0 auto;">
        ...
        <br><br>
        <h3 style="text-align:left;color: rgb(44 59 83);font-size: 22px;line-height: 38px;text-transform: Capitalize;font-weight: 500;margin-bottom: 10px;">What happens next?</h4>
        <p style="font-size:15px;text-align:left;text-transform: capitalize;color: #2b3a53;font-weight:400;">This email will have a document attached, which you will need to fill in so we have a better understanding of what type of vehicles you are looking to stock. 
        ...
        <div style="padding: 5px 20px; background: #e74f42;">
                ...
                <p style="font-size: 13px;text-align: center;text-transform: capitalize;color:#fff;font-weight:400;">(They must meet the requirements to sign up with us and purchase at least one vehicle).</p>                
            </div> 
