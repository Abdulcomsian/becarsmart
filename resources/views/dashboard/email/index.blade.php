            ...
            <div class="card">
                ...
                <div class="card-body pt-5">
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="{{url('dashboard/template8')}}" type="button" class="btn btn-dark w-100">Email Template 8</a>
                        </div>
                    </div>
                    <br><br>
                    <div class="row">
                        <div class="col-md-3">
                            <a href="{{url('frontend/template9')}}" type="button" class="btn btn-dark w-100">Email Template 9</a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{url('frontend/template10')}}" type="button" class="btn btn-dark w-100">Email Template 10</a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{url('frontend/template11')}}" type="button" class="btn btn-dark w-100">Email Template 11</a>
                        </div>
                    </div>
                </div>
                <!--end::Card body-->
