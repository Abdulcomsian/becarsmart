        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <form class="pt-5" method="post" action="{{route('dashboard.about.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div id="aboutsection">
                            <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="post" id="form_{{$data->id}}" action="{{url('about-us-delete')}}">
                                        @csrf
