        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <button type="submit" class="btn btn-warning delete_all" data-url="{{ url('buy-car-lead-delete-all') }}">Delete All Select</button>
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" class="sub_chk" data-id="{{$all->id}}">
                                </td>
                                <td class="">
                                        {{$all->questions[0] ?? ''}} <br>
                                        {{$all->questions[1] ?? ''}}
